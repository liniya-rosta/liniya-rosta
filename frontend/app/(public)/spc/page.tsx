...
export const generateMetadata = async (): Promise<Metadata> => ({
    title: "SPC ламинат",
    description: "SPC ламинат — влагостойкое и износостойкое покрытие с реалистичной текстурой дерева или камня. Подходит для кухни, ванной и жилых помещений. Обладает шумоизоляцией и устойчив к ультрафиолету.",    openGraph: {
        ...
        images: [
            {
                url: "/images/services/main-service.JPG", // можешь заменить на более релевантную
                width: 1200,
                height: 630,
