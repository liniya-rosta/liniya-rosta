...
const HeroSection = () => {
    ...
    return (
        <section aria-labelledby="hero-heading" className="text-center space-y-6 mb-10 md:mb-20">
            <div className="md:relative w-full md:h-[500px] mb-8 -mt-[35px]">
                ...
                <div className="md:absolute md:inset-0 flex items-center justify-center md:text-white px-4">
                    <div className="md:bg-black/40 md:backdrop-blur-sm p-6 md:rounded-2xl md:shadow-lg max-w-3xl mx-auto space-y-6">
                    <h1 className="bg-gradient-to-r from-[#b9c8d6] to-[#e68210] text-transparent bg-clip-text font-bold tracking-tight w-fit mx-auto text-30-48-1_2 drop-shadow-md"
                        >
                            Линия роста
                        </h1>
                        ...
                        <div className="flex gap-4 justify-center flex-wrap">
                            <Dialog open={isModalTopOpen} onOpenChange={setIsModalTopOpen}>
                                <DialogTrigger asChild>
                                    <Button size="lg" className="min-w-[180px] font-semibold shadow-md btn-hover-scale">
                                        Оставить заявку
                                    </Button>
                                </DialogTrigger>
                            ...
                            <Button
                                variant="outline"
                                size="lg"
                                className="min-w-[180px] border-primary btn-hover-scale"
                                asChild
                            >
