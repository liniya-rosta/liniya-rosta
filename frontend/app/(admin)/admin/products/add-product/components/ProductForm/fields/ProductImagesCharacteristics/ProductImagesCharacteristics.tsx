...
import ProductImages
    from "@/app/(admin)/admin/products/add-product/components/ProductForm/fields/ProductImagesCharacteristics/ProductImages";
import ProductCharacteristics
    from "@/app/(admin)/admin/products/add-product/components/ProductForm/fields/ProductImagesCharacteristics/ProductCharacteristics";
