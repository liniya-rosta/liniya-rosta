                ...
                <div className="border-b border-b-gray-500 py-3 mb-4">
                    ...
                    <div className="mb-3">
                        <Input
                            className="mb-2"
                            type="text"
                            placeholder="SEO заголовок (до 120 символов)"
                            maxLength={120}
                            disabled={createLoading}
                            {...register("seoTitle")}
                        />
                    ...
                    <div className="mb-3">
                        <textarea
                            placeholder="SEO описание (до 300 символов)"
                            maxLength={300}
                            disabled={createLoading}
                            {...register("seoDescription")}
                            className="w-full border border-input rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-50"
                            rows={4}
                        />
