...
const ProductFormModal: React.FC<ProductFormModalProps> = ({isOpen, onClose, isEditing, editingProduct, categories, actionLoading, onSubmit,}) => {
    ...
    const handleSubmit = (data: CreateProductFormData | UpdateProductFormData) => {
        if (!isEditing && !(data as CreateProductFormData).image) {
            form.setError("image", {
                type: "manual",
                message: "Изображение обязательно для нового продукта",
            });
            return;
        }
