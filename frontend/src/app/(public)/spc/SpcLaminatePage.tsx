...
import LaminateCard from "@/src/app/(public)/spc/components/LaminateCard";
...
const SpcLaminatePage: React.FC<Props> = ({initialData, error, categoryName}) => {
    ...
    return (
        <div className="mb-6">
            <h3 className="service-section-title text-23-30-1_5">Каталог {categoryName ? `${categoryName}` : ''}</h3>
            <Swiper
                slidesPerView={1}
                navigation
