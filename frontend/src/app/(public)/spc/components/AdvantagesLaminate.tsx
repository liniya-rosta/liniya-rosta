import AdvantageLaminateCard from "@/src/app/(public)/spc/components/AdvantageLaminateCard";
...
const advantages = [
    {
        ...
        icon: <Waves size={52} strokeWidth={1} className="text-highlight-light"/>
    }, {
        title: "Эстетика",
        text: "Реалистичное изображение древесины, камня и других текстур.",
        icon: <Brush size={52} strokeWidth={1} className="text-highlight-light"/>
    }, {
        ...
        icon: <ShieldCheck size={52} strokeWidth={1} className="text-highlight-light"/>
    }, {
        ...
        icon: <Volume2 size={52} strokeWidth={1} className="text-highlight-light"/>
    },
];
...
const AdvantagesLaminate = () => {
    return (
        <div className="mb-[70px] sm:mb-[55px]">
            <h3 className="text-23-30-1_5 service-section-title">Преимущества SPC ламината</h3>
