...
import ProductsSection from "@/src/app/(public)/(home)/components/ProductsSection";
import PortfolioSection from "@/src/app/(public)/(home)/components/PortfolioSection";
import InstagramSection from "@/src/app/(public)/(home)/components/InstagramSection";
import ConsultationSection from "@/src/app/(public)/(home)/components/ConsultationSection";
import {useContactStore} from "@/store/contactsStore";
import LoadingFullScreen from "@/src/components/ui/Loading/LoadingFullScreen";
import {useServiceStore} from "@/store/serviceStore";
import ServiceSection from "@/src/app/(public)/(home)/components/ServiceSection";
