...
const ServicesTitle = async () => {
    ...
    return (
        <AnimatedEntrance className="text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.85)] bg-white/40 rounded-2xl p-8 backdrop-blur-sm">
            <h1 className="text-30-48-1_2 font-bold mb-8">
                Линия роста —{' '}
                <span  className="text-highlight-light">{tServices("slogan.part1")}</span>,{' '}
                <span className="text-popover/90">{tServices("slogan.part2")}</span>
            </h1>
