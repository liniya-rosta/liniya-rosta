...
export const AnimatedButton: React.FC<AnimatedButtonProps> = ({ text }) => (
    <div className="absolute bottom-1/4 right-8 z-20 transform translate-x-6 opacity-0 transition-all duration-500 group-hover:translate-x-0 group-hover:opacity-100">
        <BtnArrow
